...
class AboutUs extends StatelessWidget {
  ...
  showLicences(context) {
    showAboutDialog(
        ...
        applicationLegalese:
            "Team Naari is providing with a solution to female’s problems, an entirely userfriendly app and a need of the hour, aiming to connect you to the ones who care for you!");
  }
}
